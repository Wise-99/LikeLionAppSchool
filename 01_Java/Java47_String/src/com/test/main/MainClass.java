...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// equals 는 두 객체가 관리하는 값이 같은지를 비교하는 것이다.
		...
		// tpUpperCase : 소문자를 대문자로 하는 문자열을 생성한다.
		...
		String str13 = str12.substring(2);		// 순서값 2부터 끝까
		String str14 = str12.substring(2, 5);	// 순서값 2부터 5 - 1 까지
