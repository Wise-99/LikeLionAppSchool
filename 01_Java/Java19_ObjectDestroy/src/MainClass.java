...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// 메모리가 청소 작업이 수행되면 소멸의 대상이 되는 객체는 모두 메모리에서 사라진다.
        ...
        // 가비지 컬렉션 : 쓰레기들을 모아 버린다는 의미를 가지고 있다.
        // 프로그래밍 언어에서 더이상 사용하지 않지만 메모리를 차지하고 있는 것들을 모아 제거하는 작업을 의미한다.
        // 가비지 컬렉터 : 가비지 컬렉션을 해주는 소프트웨어
        
        // 가비지 컬렉션은 매우 부담되는 작업이기 때문에 너무 많이 발생하지 않는 것이 중요하다.
        for(int i = 0 ; i < 100 ; i++) {
