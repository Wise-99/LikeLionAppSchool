...
open class ChinaFood(var name:String, var price:Int){
...
class JJamPPong : ChinaFood{

    private var hasMuseel: Boolean
...
class BockUmBab : ChinaFood{

    private var soupType: String
