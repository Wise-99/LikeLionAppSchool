...
*/
        ...
        println("잠만보 인형 : $jammanboCount 개")
    }

    // 생산한 장난감들의 정보를 출력하는 함수
    fun printToyInfo(){
        // 장난감의 수 만큼 반복한다.
        for(tempToy in toyList){
    ...
    // 생산한 장난감들의 총 가격과 평균 가격을 구해 출력하는 함수
    fun printToyTotalAvgPrice(){
        // 장난감들의 가격의 총 합을 담을 변수
        var priceTotal = 0
